...
import { MapIcon } from "@/assests/icons/svgicons";
      ...
      <div className="flex items-center gap-10">
        ...
        <div className="bg-white rounded-lg p-5 w-1/2">
          ...
          <ul className="space-y-2">
            <li className="border border-gray-200 text-[15px] rounded-lg hover:bg-gray-100 transition-all duration-300">
              <Link
                href={"https://maps.app.goo.gl/ep42eMN2vidPhGB78"}
                target="_blank"
                className=""
              >
                <h4 className="p-2 flex items-center gap-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                  ...
                  <span className="font-semibold text-red-500">Farg`ona</span> -
            ...
            <li className="border border-gray-200 text-[15px] rounded-lg hover:bg-gray-100 transition-all duration-300">
              ...
              >
                <h4 className="p-2 flex items-center gap-1">
                  ...
                  <span className="font-semibold text-red-500">Samarqand</span>{" "}
