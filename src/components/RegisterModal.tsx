        ...
        <div className="fixed left-1/2 -translate-x-1/2 bg-white top-1/2 -translate-y-1/2 p-8 pt-10 rounded-lg max-w-sm w-full">
          ...
          <div className="space-y-5">
            ...
            <div className="relative">
              ...
              <label
                htmlFor="phoneId"
                className="text-[16px] text-gray-400 absolute bg-white left-2 -top-3 transition-all duration-200 cursor-text"
              >
            ...
            <div className=" text-[14px] text-center">
              <p>
                Akkauntingiz bormi? {' '}
                <button className="text-red-500 font-semibold"> Kirish </button>
              </p>
            </div>
          </div>
        </div>
