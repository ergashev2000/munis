        ...
        <div className="w-3/4">
          <article>
            ...
            <p>
              ...
              iure libero obcaecati distinctio ducimus, sapiente vero ipsa autem
              tenetur sit veniam suscipit minus optio repudiandae. Dolorem quas
              quam enim ad dolorum iste aliquid mollitia non? Quaerat quae enim
              obcaecati facilis fugit omnis corporis aliquam voluptas dicta et
              voluptates voluptatibus impedit, quibusdam,
              <br /> <br />
              veritatis repellendus alias ipsum architecto! Lorem ipsum dolor,
              sit amet consectetur adipisicing elit. Omnis, assumenda molestiae
              natus incidunt nesciunt aperiam inventore. Consequatur sunt facere
              rerum tempora omnis, iste officiis animi officia expedita
              necessitatibus tempore eveniet!
            </p>
          </article>
